...
public class BlueLong extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path5 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(61.000, 15.000), new Pose(35.000, 15.000))
                    )
            ...
            Path6 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(35.000, 15.000), new Pose(12.000, 15.000))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
    ...
    public void loop() {
        ...
        switch (pathState) {
            ...
            case 15:
                Intake.In();
                follower.followPath(PathChain.Path6,.6,true);
                Shooter.FastSpinTable();
                Intake.In();
                mStateTime.reset();
                v_state++;
